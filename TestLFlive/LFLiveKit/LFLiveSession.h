...
- (void)handleVideo:(nullable LFLiveSession *)session frame:(nullable CVPixelBufferRef)frame;
@end
...
/** The start stream .*/
- (void)startLive:(nonnull LFLiveStreamInfo *)streamInfo isEnc:(BOOL) isEnc;
